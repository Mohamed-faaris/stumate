...
export default function LoginPage() {
	...
	const handleDiscordLogin = async () => {
		...
		try {
			...
			if (result?.error) {
				setError(result.error.message || "Discord login failed");
			}
		} catch (err) {
			setError(err instanceof Error ? err.message : "An error occurred");
		} finally {
