		...
		<div className="mx-auto max-w-4xl rounded-lg bg-white p-6 shadow-md">
			...
			<div className="mb-8">
				...
				<form onSubmit={handleSubmit} className="space-y-4">
					<div>
						<label htmlFor="form-title" className="block font-medium text-gray-700 text-sm">
							Title
						</label>
						<input
							type="text"
					...
					<div>
						<label htmlFor="form-description" className="block font-medium text-gray-700 text-sm">
							Description
						</label>
						<textarea
							id="form-description"
