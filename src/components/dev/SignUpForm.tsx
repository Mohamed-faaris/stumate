	...
	return (
		<div className="mx-auto max-w-md rounded-lg bg-white p-6 shadow-md">
			...
			<form onSubmit={handleSubmit} className="space-y-4">
				<div>
					<label htmlFor="signup-name" className="block font-medium text-gray-700 text-sm">
						Name
					</label>
					<input
						type="text"
				...
				<div>
					<label htmlFor="signup-email" className="block font-medium text-gray-700 text-sm">
						Email
					</label>
					<input
						type="email"
				...
				<div>
					<label htmlFor="signup-password" className="block font-medium text-gray-700 text-sm">
						Password
					</label>
					<input
						type="password"
